...
export const StarsIconEmpty = ({ className = '' }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
...
export const HomeIconEmpty = ({ className = '' }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    className={`fill-current stroke-current stroke-0 ${className}`}
  >
...
export const SearchIconEmpty = ({ className = '' }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    className={`fill-current stroke-current stroke-0 ${className}`}
  >
...
export const BellIconEmpty = ({ className = '' }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    className={`fill-current stroke-current stroke-0 ${className}`}
  >
...
export const MailBoxIcon = ({ className = '' }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    className={`fill-current stroke-current stroke-0 ${className}`}
  >
...
export const Retweet = ({ className = '' }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    className={`fill-current stroke-current stroke-0 ${className}`}
  >
...
export const HeartEmpty = ({ className = '' }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    className={`fill-current stroke-current stroke-0 ${className}`}
  >
